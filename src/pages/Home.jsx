...
const Home = () => {
	...
	const loaded = () => (
		<div className="Home">
			<img className="hero-image" src={about.headshot} />
			<section className="hero">
				<div className="hero-text">
					...
					<img
						src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=5589AA&center=true&vCenter=true&random=false&width=320&lines=Software+Engineer;ServiceNow+Developer;Technologist"
						alt="software engineer, servicenow developer, technologist"
					/>
					<p>{about.bio}</p>
				</div>
			</section>
			<section className="skill-list">
				...
				>
					<path
						fill="#44b78b"
						d="M14.135 4H18.1v18.169a26.218 26.218 0 0 1-5.143.535c-4.842-.005-7.362-2.168-7.362-6.322c0-4 2.673-6.6 6.816-6.6a6.448 6.448 0 0 1 1.724.2zm0 9.142a3.992 3.992 0 0 0-1.337-.2c-2 0-3.163 1.223-3.163 3.366c0 2.087 1.107 3.239 3.138 3.239a9.355 9.355 0 0 0 1.362-.1v-6.3Z"
					/>
					<path
						fill="#44b78b"
			...
			<section className="cta-buttons">
				...
				<a href="/jeff-mancilla-resume.pdf">
					<button>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="16"
						...
						>
							<path
								fill="currentColor"
								d="m1243 0l549 549v1499H128V0zm37 219v293h293zM256 1920h1408V640h-512V128H256zm256-896V896h896v128zm0 256v-128h896v128zm0 256v-128h896v128z"
							/>
						</svg>
						Resume
					</button>
	...
	return about ? loaded() : <span>loading...</span>
}
